...
func TestAnd(t *testing.T) {
	...
	t.Run("IGNORE and Expression", func(t *testing.T) {
		and := And{Args: []Expression{IGNORE, Reference{Name: "x"}}}
		result := and.Evaluate(Input{"x": UNKNOWN})
	...
	t.Run("IGNORE and two Expressions", func(t *testing.T) {
		and := And{Args: []Expression{IGNORE, Reference{Name: "x"}, Reference{Name: "y"}}}
		result := and.Evaluate(Input{"x": UNKNOWN, "y": UNKNOWN})
		expected := And{Args: []Expression{Reference{Name: "x"}, Reference{Name: "y"}}}
		if !reflect.DeepEqual(result, expected) {
			t.Errorf("Expected %v, got %v", expected, result)
		}
	})
	...
	t.Run("UNSET and UNKNOWN", func(t *testing.T) {
		and := And{Args: []Expression{UNSET, Reference{Name: "x"}}}
		result := and.Evaluate(Input{"x": UNKNOWN})
		expected := UNSET
		if !reflect.DeepEqual(result, expected) {
			t.Errorf("Expected %v, got %v", expected, result)
...
func TestOr(t *testing.T) {
	...
	t.Run("IGNORE or UNKNOWN", func(t *testing.T) {
		or := Or{Args: []Expression{IGNORE, Reference{Name: "x"}}}
	...
	t.Run("UNSET or UNKNOWN", func(t *testing.T) {
		or := Or{Args: []Expression{UNSET, Reference{Name: "x"}}}
		result := or.Evaluate(Input{"x": UNKNOWN})
		expected := Reference{Name: "x"}
		if !reflect.DeepEqual(result, expected) {
			t.Errorf("Expected %v, got %v", expected, result)
